...
export default function Projects(props) {
  const websites = [
    {
      name: "Admin Portal",
      demo: "https://uat-admin-portal.salesfine.co/auth/login",
      repo: null,
      img: "https://i.postimg.cc/ZKm2HhXv/image.png",
      data: "Admin dashboard for managing data with advanced tables, filters, and dynamic forms. Built withNext.js, focusing on scalable architecture, performance, and reusable components.",
      role: "UI development",
  type:'featured',
    },
    {
      ...
      data: "Training management system for handling courses, coaches, and trainees, including authentication, course enrollment, and certification workflows.Built with a focus on clean UI, reusable components, and efficient data handling.",
      role: "UI development",
        type:'featured',
    ...
    },
    {
      ...
      data: "Data-driven web application for analyzing and visualizing country-level indicators.Worked on building responsive UI components, handling complex data presentation, and improving user experience.",
      role: "UI development",  type:'featured',
    ...
    // },
    {
      ...
      data: "Government services portal for the Eastern Province of Saudi Arabia, providing multiple digital services related to geographic information systems.Contributed to building scalable and responsive UI components, focusing on performance and user experience.",
      role: "UI/UX development",  type:'featured',
    ...
    },
    {
      ...
      data: "Electronic services portal for Riyadh, Saudi Arabia, enabling citizens, residents, and businesses to access and manage municipal services efficiently.Focused on frontend development, improving performance, and delivering a seamless user experience.",
      role: "UI/UX development",  type:'featured',
...

    {
      ...
      role: "UI/UX development",      type:'other'
    ...
    {
      name: "Pokemon React",
      demo: " https://pokemon-react-odknztzfk-ayshashokrys-projects.vercel.app/",
      repo: "https://github.com/ayshashokry/pokemon-react",
      img: "https://i.postimg.cc/xdyVn1rf/image.png",
      data: "A fun interactive project built to explore API integration, state management, and dynamic UI rendering using React.",
      role: "UI/UX development",
      type:'experimental'
    ...
    },
    {
      ...
      data: "A responsive company website built to practice UI implementation, layout structuring, and reusable component design. ",
      role: "UI development",type:'experimental'
    },
    {
      name: "U-Code",
  ...
  return (
    <div className={styles.main} id={!props.homePage && styles.projMain}>
      ...
      <div className={styles.projectsDiv}>
        {!props.homePage ? (
  Object.entries(
    websitesToShow.reduce((acc, item) => {
    ...
    const titles = {
      ...
      experimental: "Side Projects & Experiments",
    };

    return (
      <div key={type}>
        {/* Title */}
        <h2 className={styles.sectionTitle}>{titles[type]}</h2>
